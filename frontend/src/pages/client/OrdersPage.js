      ...
      {loading ? <div className="empty-state">Chargement...</div>
        ...
        return (
          <div key={o._id} className="card" style={{ marginBottom: '1rem' }}>
            <div style={{ padding: '1rem 1.25rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer', gap: '.75rem', flexWrap: 'wrap' }} onClick={() => setExpanded(open ? null : o._id)}>
              ...
              <div style={{ borderTop: '1px solid #f3f4f6', padding: '1.25rem' }}>
                ...
                {o.statut !== 'annulee' && (
                  <div className="progress-bar-wrap">
                    <div className="progress-bar-inner" style={{ display: 'flex', position: 'relative' }}>
